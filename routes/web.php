...
Route::resource('laundry',\App\Http\Controllers\LaundryController::class)->middleware('auth');
...
Route::get('laundries/fetch', [\App\Http\Controllers\LaundryController::class, 'fetch'])->middleware('auth');
Route::get('laundries/print/{id}', [\App\Http\Controllers\LaundryController::class, 'print'])->middleware('auth');
Route::get('laundries/thermal_print/{id}', [\App\Http\Controllers\LaundryController::class, 'thermal_print'])->middleware('auth');
Route::get('laundries/report', [\App\Http\Controllers\LaundryController::class, 'report'])->middleware('auth');
Route::get('laundries/graph_report', [\App\Http\Controllers\LaundryController::class, 'graph_report'])->middleware('auth');
Route::get('laundries/annual_revenue', [\App\Http\Controllers\LaundryController::class, 'annual_revenue'])->middleware('auth');
Route::get('laundries/receipt/{id}', [\App\Http\Controllers\LaundryController::class, 'view_receipt'])->middleware('auth')->name('payment.view');
Route::post('laundries/save_payment', [\App\Http\Controllers\LaundryController::class, 'save_payment'])->middleware('auth')->name('payment.save');
